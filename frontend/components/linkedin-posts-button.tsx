  ...
  return (
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 hidden md:block">
      <Link href="/dashboard/linkedin-posts">
        <Button
          size="lg"
          className="bg-brand-primary hover:bg-brand-primary/90 text-white rounded-full shadow-xl px-6 py-4 transition-all duration-300 ease-in-out hover:scale-105 flex items-center"
        >
