...
function LandingHero() {
	...
	return (
		<div className="relative min-h-[100vh] flex items-center pt-24 md:pt-40 pb-32 overflow-hidden px-4">
			{/* Ambient shapes */}
				...
				<div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
					...
					<div className="lg:col-span-7 text-center lg:text-left">
						...
						>
							...
							{/* Mode switch */}
							<div className="mt-8 hidden sm:inline-flex sm:w-auto p-1 rounded-xl bg-white/5 ring-1 ring-white/10 backdrop-blur">
