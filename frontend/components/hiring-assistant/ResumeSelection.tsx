...
export default function ResumeSelection({
  ...
  return (
    <div>
      ...
      {resumeSelectionMode === "existing" ? (
        <div>
          <Label className="text-brand-light mb-3 flex items-center font-medium text-sm">
            ...
            <AnimatePresence>
              {showResumeDropdown && (
                <motion.div
                  ...
                  className="absolute top-full mt-2 w-full bg-brand-dark border border-white/20 rounded-xl shadow-2xl z-50 overflow-hidden"
                >
                  {isLoadingResumes ? (
        ...
        <div>
          <Label
            htmlFor="resume"
            className="text-brand-light mb-3 flex items-center font-medium text-sm"
          >
            <FileText className="mr-2 h-4 w-4 text-brand-primary" />
            Resume File *
          </Label>
          <div className="relative">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/0 via-brand-primary/5 to-brand-primary/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
          ...
          {resumeText && (
            <motion.div
              ...
              className="mt-3 p-3 bg-gradient-to-r from-brand-primary/10 to-brand-primary/5 border border-brand-primary/20 rounded-lg backdrop-blur-sm"
            >
              <div className="flex items-start space-x-2">
                <FileText className="h-4 w-4 text-brand-primary mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-brand-light/90 text-xs font-medium mb-1">
                    File Preview:
                  </p>
