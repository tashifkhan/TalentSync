    ...
    <Card className="backdrop-blur-xl bg-white/5 border border-white/10 shadow-2xl hover:bg-white/10 transition-all duration-500 flex-1 flex flex-col max-h-[calc(100vh-16rem)]">
      <CardHeader className="pb-4 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-brand-light text-lg md:text-xl font-semibold flex items-center">
              ...
              ([question, answer], index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="text-brand-light font-medium text-sm leading-relaxed pr-2">
                      <span className="inline-block bg-gradient-to-r from-brand-primary to-brand-primary/80 text-white text-xs px-2 py-1 rounded-full mr-2 font-medium">
                        Q{index + 1}
                      </span>
                      {question}
                    </h4>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <motion.div
                ...
                className="mb-4"
              >
                <Users className="h-12 w-12 text-brand-light/30 mx-auto" />
              </motion.div>
              <h3 className="text-brand-light/80 text-base font-medium mb-2">
                Ready to Generate?
              </h3>
              <p className="text-brand-light/60 text-sm leading-relaxed max-w-xs mx-auto">
