      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Card className="h-full p-6 md:p-8 bg-brand-dark/40 border-0 ring-1 ring-white/5 backdrop-blur-md group hover:bg-brand-dark/60 transition-colors">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-brand-light/40">Schema Design</p>
                </div>
              </div>

              <div className="relative group/image overflow-hidden rounded-xl border border-white/10 bg-brand-darker mb-6 shadow-xl">
                ...
                {/* Gradient Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/80 via-transparent to-transparent opacity-0 group-hover/image:opacity-100 transition-opacity duration-300 pointer-events-none" />
              </div>
            ...
            <Card className="h-full p-6 md:p-8 bg-brand-dark/40 border-0 ring-1 ring-white/5 backdrop-blur-md group hover:bg-brand-dark/60 transition-colors">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-brand-light/40">ER Diagram</p>
                </div>
              </div>
