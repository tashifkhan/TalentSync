	...
	return (
		<section id="problem" className="relative scroll-mt-28 py-24 px-6">
			<div className="mx-auto max-w-6xl">
				...
				>
					<div className="inline-flex items-center gap-2 px-3 py-1 mb-6 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-300 text-xs font-medium uppercase tracking-wider">
					...
					<p className="text-[#EEEEEE]/60 text-lg leading-relaxed">
				...
				<div className="grid md:grid-cols-2 gap-8">
					{stats.map((s, i) => {
						...
						return (
							...
							>
								<Card className="relative overflow-hidden border-0 bg-[#1a2026]/40 backdrop-blur-md p-10 h-full group hover:bg-[#1a2026]/60 transition-colors duration-300">
									{/* Background Glow */}
									<div
									...
									<div className="relative z-10 flex flex-col items-center text-center">
										...
										<div className="text-xl font-semibold text-[#EEEEEE] mb-4">
											{s.label}
										</div>

										<p className="text-base text-[#EEEEEE]/50 leading-relaxed max-w-sm mx-auto group-hover:text-[#EEEEEE]/70 transition-colors">
											{s.description}
										</p>
									</div>
