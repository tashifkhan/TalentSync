				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0 sm:gap-6 md:gap-8 divide-y divide-white/5 sm:divide-y-0">
					{valuePoints.map((p, i) => (
						<motion.div
							...
							className="group relative overflow-hidden sm:rounded-2xl sm:border sm:border-white/10 sm:bg-gradient-to-b sm:from-white/5 sm:to-white/[0.02] p-5 sm:p-6 sm:backdrop-blur-sm sm:hover:border-[#76ABAE]/40 sm:hover:shadow-[0_0_0_1px_#76ABAE40,0_4px_40px_-8px_#76ABAE40] transition-all"
						>
							<div className="flex items-start gap-4">
								<div className="relative shrink-0">
									<div className="absolute inset-0 rounded-xl bg-[#76ABAE]/30 blur-xl opacity-0 group-hover:opacity-60 transition" />
									<div className="h-12 w-12 rounded-xl flex items-center justify-center bg-white/5 sm:bg-[#76ABAE]/15 ring-1 ring-white/10 sm:ring-[#76ABAE]/40 text-[#76ABAE]">
