	...
	return (
		...
		>
			<Link href="/dashboard/cold-mail">
				<Button className="bg-gradient-to-r from-brand-primary to-[#5A8B8F] hover:from-[#5A8B8F] hover:text-brand-primary text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 button-hover">
