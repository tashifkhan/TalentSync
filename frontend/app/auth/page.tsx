      ...
      {!isPageLoading && (
        <div className="min-h-screen relative overflow-visible">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/2 -right-20 w-96 h-96 bg-brand-dark/30 rounded-full blur-3xl animate-pulse delay-1000"></div>
          ...
          >
            <Link href="/">
              <Button
                variant="ghost"
                className="text-white hover:text-brand-primary hover:bg-white/10 backdrop-blur-sm border border-white/20 transition-all duration-300"
              >
            ...
            >
              <Tabs defaultValue={defaultTab} className="w-full">
                <TabsList className="grid w-full grid-cols-2 bg-white/5 backdrop-blur-lg h-14 rounded-xl p-1 mb-8 border border-white/10">
                  <TabsTrigger
                    value="login"
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-brand-primary data-[state=active]:to-brand-secondary data-[state=active]:text-white data-[state=active]:shadow-lg text-brand-light/70 rounded-lg transition-all duration-300 font-medium py-3"
                  >
                    Sign In
                  </TabsTrigger>
                  <TabsTrigger
                ...
                <TabsContent value="login">
                  <Card className="backdrop-blur-lg bg-white/5 border border-white/10 shadow-2xl rounded-xl">
                    <CardHeader className="text-center pb-6">
                      <CardTitle className="text-2xl font-bold text-brand-light mb-2">
                        Welcome back!
                      </CardTitle>
                      <CardDescription className="text-brand-light/60 text-base">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <Button
                          ...
                          disabled={isLoading}
                          type="button"
                          className="w-full h-12 bg-white hover:bg-brand-lighter text-foreground border border-border hover:border-border-subtle shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 rounded-xl font-medium"
                        >
                          {isLoading ? (
                        ...
                        <Button
                          ...
                          disabled={isLoading}
                          type="button"
                          className="w-full h-12 bg-github hover:bg-github-hover text-white border border-border-subtle hover:border-text-muted-medium shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 rounded-xl font-medium"
                        >
                          {isLoading ? (
                            <Loader variant="spinner" size="sm" />
                          ) : (
                      ...
                      <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm uppercase">
                          <span className="bg-white/10 backdrop-blur-sm px-4 py-1 text-brand-light/60 rounded-full border border-white/10">
                      ...
                      <form onSubmit={handleLogin} className="space-y-5">
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <Input
                              ...
                              required
                              className="pl-10 h-12 bg-white/10 border-white/20 text-brand-light placeholder:text-brand-light/50 focus:bg-white/15 focus:border-brand-primary/50 transition-all duration-300 rounded-xl"
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            ...
                            <Label
                              htmlFor="remember"
                              className="text-sm text-brand-light/70"
                            >
                              Remember me
                            </Label>
                          </div>
                        ...
                        <Button
                          type="submit"
                          className="w-full h-12 bg-gradient-to-r from-brand-primary to-brand-secondary hover:from-brand-secondary hover:to-brand-primary text-white shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 rounded-xl font-medium text-lg"
                          disabled={isLoading}
                        >
                      ...
                      <form onSubmit={handleRegister} className="space-y-5">
                        <div className="grid grid-cols-1 gap-5">
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-brand-primary" />
                              <Input
                                id="register-name"
                                type="text"
                          ...
                          <div className="space-y-2">
                            ...
                            <select
                              ...
                              required
                              className="w-full h-12 bg-white/10 border border-white/20 text-brand-light focus:bg-white/15 focus:border-brand-primary/50 transition-all duration-300 rounded-xl px-3 cursor-pointer"
                            >
                              <option
                                value=""
                                disabled
                        ...
                        <div className="space-y-3">
                          <Label className="text-brand-light font-medium">
                          ...
                          <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl border border-white/10">
                            ...
                            <div className="flex-1 space-y-2">
                              <Input
                                ...
                                className="bg-white/10 border-white/20 text-brand-light placeholder:text-brand-light/40 focus:bg-white/15 focus:border-brand-primary/50 transition-all duration-300 rounded-lg"
                              />
                        ...
                        <div className="flex items-start space-x-3 pt-2">
                          <input
                            ...
                            id="terms"
                            required
                            className="accent-brand-primary w-4 h-4 rounded mt-0.5"
                          />
                          <Label
                            htmlFor="terms"
                            className="text-sm text-brand-light/70 leading-relaxed"
                          >
                            I agree to the{" "}
                            <Link
                              href="/terms"
                              className="text-brand-primary hover:text-brand-primary/80 underline font-medium"
                            >
                              Terms of Service
                            </Link>{" "}
                            and{" "}
                        ...
                        <Button
                          type="submit"
                          className="w-full h-12 bg-gradient-to-r from-brand-primary to-brand-secondary hover:from-brand-secondary hover:to-brand-primary text-white shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 rounded-xl font-medium text-lg mt-6"
                          disabled={isLoading}
                        >
                          {isLoading && <Loader variant="spinner" size="sm" />}
      ...
      fallback={
        <div className="min-h-screen flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            <Card className="border-brand-primary/20 bg-brand-dark/90 backdrop-blur-sm shadow-2xl">
