          ...
          <div className="container mx-auto px-4 py-8">
            ...
            >
              <Link href="/">
                <Button
                  variant="ghost"
                  className="text-brand-light hover:text-brand-primary hover:bg-white/5 transition-all duration-300"
                >
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Link href="/dashboard/cold-mail">
                    <Card className="backdrop-blur-lg bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300 cursor-pointer group">
                      <CardContent className="p-8 text-center">
                        <Mail className="h-12 w-12 text-brand-primary mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                        ...
                        <Button className="bg-brand-primary hover:bg-brand-primary/80 text-white">
                          Generate Cold Mail
                        </Button>
                      </CardContent>
                    </Card>
                  ...
                  <Link href="/dashboard/hiring-assistant">
                    <Card className="backdrop-blur-lg bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-300 cursor-pointer group">
                      <CardContent className="p-8 text-center">
                        <Users className="h-12 w-12 text-brand-primary mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                        <h3 className="text-brand-light font-semibold text-xl mb-3">
                          Hiring Assistant
                        </h3>
                        <p className="text-brand-light/60 text-sm mb-4">
