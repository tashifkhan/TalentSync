										...
										<Link href="/dashboard/recruiter" className="block h-full">
											<CardContent className="p-6 h-full flex flex-col justify-between">
												<div>
													...
													<p className="text-brand-light/70 text-sm">
														Advanced tools to find, analyze, and manage top talent
														efficiently.
													</p>
												</div>
											...
											>
												...
												<div className="p-4 space-y-4">
													{session.questionsAndAnswers.map((qa, idx) => (
														<div key={idx} className="pl-4 border-l-2 border-brand-primary/30">
											...
											>
												...
												<div className="p-4 space-y-4">
													{session.emails.map((email, idx) => (
														<div key={idx} className="bg-brand-dark/50 rounded-lg p-4 border border-white/5">
															...
															<p className="text-sm text-brand-light/80 whitespace-pre-wrap font-mono text-xs leading-relaxed">
																{email.body}
															</p>
														</div>
													))}
