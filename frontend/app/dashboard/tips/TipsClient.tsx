...
export default function TipsClient() {
  ...
  const { data: tipsData, isLoading: loading, error } = useTips(category, skills);
              ...
              <div className="min-h-[60vh] flex items-center justify-center">
                <div className="text-center">
                  ...
                  >
                    ...
                    <div className="text-[#EEEEEE]/60 mb-4">{(error as Error).message}</div>
                    <Link href="/dashboard/seeker">
                        <Button className="bg-[#76ABAE] hover:bg-[#76ABAE]/90">Go Back</Button>
                    </Link>
                  </motion.div>
                </div>
              </div>
