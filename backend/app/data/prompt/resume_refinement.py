...
keyword_injection_prompt = PromptTemplate(
    input_variables=[
        "keywords_to_inject",
        "current_resume",
        "master_resume",
    ...
    template=KEYWORD_INJECTION_PROMPT,
)

validation_polish_prompt = PromptTemplate(
    input_variables=[
        "resume",
        "master_resume",
    ],
    template=VALIDATION_POLISH_PROMPT,
)


def build_keyword_injection_chain(llm: BaseChatModel):
    return keyword_injection_prompt | llm


def build_validation_polish_chain(llm: BaseChatModel):
    return validation_polish_prompt | llm
